...
describe 'Montgomery::Collection' do
  ...
  describe 'new instance' do
    ...
    it 'should return subcollection' do
      @mongo_collection.expects(:[]).with('small')
      @collection['small'].should.be.an.instance_of(Montgomery::Collection)
    end
    ...
    describe 'with entity' do
      ...
      it 'should find entities with a block' do
        ...
        @mongo_collection.expects(:find).with(selector, {}).yields(mongo_cursor)
